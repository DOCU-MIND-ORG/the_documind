...
@Component
public class MessagesPineconeVectorStore implements VectorStore {
    ...
    public MessagesPineconeVectorStore(
            @Value("${spring.ai.vectorstore.pinecone.memory-api-key}") String apiKey,
            @Value("${spring.ai.vectorstore.pinecone.memory-index-name}") String indexName,
        ...
        try {
            ...
            throw new RuntimeException("Failed to initialize MessagesPineconeVectorStore", e);
        }
    }
    ...
    public void add(List<Document> documents) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to upsert records to Pinecone Memory Index", e);
        }
    }
    ...
    public void delete(List<String> idList) {
        try {
            ...
            throw new RuntimeException("Failed to delete records from Pinecone Memory Index", e);
        }
    }

    @Override
    public void delete(org.springframework.ai.vectorstore.filter.Filter.Expression filterExpression) {
        throw new UnsupportedOperationException("Deleting by filter expression is not supported yet for MessagesPineconeVectorStore.");
    }
    ...
    public void deleteBySessionId(Long sessionId) {
        ...
        try {
            ...
            java.util.concurrent.CompletableFuture.runAsync(() -> {
                try {
                    api.deleteVectors(deleteRequest);
                    System.out.println("Successfully deleted memory history for session " + sessionId);
                } catch (Exception e) {
                    System.err.println("Failed to delete history for session " + sessionId + ": " + e.getMessage());
                }
            });
        } catch (Exception e) {
            throw new RuntimeException("Failed to initiate delete history request for session " + sessionId, e);
        }
    }
    ...
    public List<Document> similaritySearch(SearchRequest request) {
        try {
            ...
            throw new RuntimeException("Failed to search records in Pinecone Memory Index", e);
        }
    }
